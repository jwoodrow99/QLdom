...
class QLdom {
	...
	edit(id, text) {
		if (typeof id !== 'undefined' && typeof text !== 'undefined') {
			...
			console.log(
				'edit - ' + '(' + 'ERROR - invalid parameter (id, text)' + ')'
			);
		} // end if
	} // end edit
	...
	clearValue(id) {
		if (typeof id !== 'undefined') {
			...
			console.log(
				'clearValue - ' + '(' + 'ERROR - invalid parameter (id)' + ')'
			);
		} // end if
	} // end clearValue
	...
	textColor(id, color) {
		if (typeof id !== 'undefined' && typeof color !== 'undefined') {
			...
			console.log(
				'textColor - ' + '(' + 'ERROR - invalid parameter (id, color)' + ')'
			);
		} // end if
	} // end textColor
	...
	backgroundColor(id, color) {
		if (typeof id !== 'undefined' && typeof color !== 'undefined') {
			...
			console.log(
				'backgroundColor - ' +
					'(' +
					'ERROR - invalid parameter (id, color)' +
					')'
			);
		} // end if
	} // end backgroundColor
	...
	changeAttribute(id, att, val) {
		if (
			...
			console.log(
				'addAttribute - ' +
					'(' +
					'ERROR - invalid parameter (id, attribute, value)' +
					')'
			);
		} // end if
	} // end addAttribute
	...
	changeClass(id, newVal) {
		if (typeof id !== 'undefined' && typeof newVal !== 'undefined') {
			...
			console.log(
				'show - ' + '(' + 'ERROR - invalid parameter (id, newVal)' + ')'
			);
		} // end if
	} // end changeClass
	...
	removeClass(id) {
		if (typeof id !== 'undefined') {
			...
			console.log(
				'removeClass - ' + '(' + 'ERROR - invalid parameter (id)' + ')'
			);
		} // end if
	} // end removeClass
	...
	changeId(id, newVal) {
		if (typeof id !== 'undefined') {
			...
			console.log(
				'changeId - ' + '(' + 'ERROR - invalid parameter (id, newVal)' + ')'
			);
		} // end if
	} // end changeId
	...
	button(text, fcn, id) {
		if (typeof fcn !== 'undefined' && typeof text !== 'undefined') {
			...
			console.log(
				'button - ' +
					'(' +
					'ERROR - invalid parameter (text, function, id)' +
					')'
			);
		} // end if
	} // end button
		...
		if (typeof id !== 'undefined') {
			...
			if (typeof r !== 'undefined' && typeof c !== 'undefined') {
				...
				console.log(
					'text area - ' +
						'(' +
						'ERROR - missing colum value (id, row, col)' +
						')'
				);
			} else if (typeof r == 'undefined' && typeof c == 'undefined') {
				r = '10';
	...
	radioButton(id, nme, val) {
		if (
			...
			console.log(
				'radio button - ' +
					'(' +
					'ERROR - invalid parameter (id, name, class)' +
					')'
			);
		} // end if
	} // end radioButton
